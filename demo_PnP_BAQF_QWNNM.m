...
ratio = Ratio_Set(2); % ratio of available data,
%%%***************************************************************
...
%%%***************************************************************
opts.lambda1 = 25 ; %% QWNNM regularization parameter % manually tuned
opts.lambda2 = 0.5; %% Local regularization parameter % manually tuned
opts.mu1 = 1e-3  ; %% QWNNM Lagrange penalty parameter
opts.mu2 = 1e-3 ; %% Local Lagrange penalty parameter
opts.mu3 = 0.01; %% Lagrange penalty parameter
...
x_out = PnPBAQF_Deblur_Inpaint(opts, x0, y_input, ht, Mask,H); 
fprintf('Running end ...\n')
fprintf('***************************************************************\n')
fprintf('***************************************************************\n')
